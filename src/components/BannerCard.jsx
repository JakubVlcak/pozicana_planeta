...
function BannerCard({ pill, title, description, buttonLabel, linkLabel, className = '' }) {
  return (
    <div className={`w-full max-w-[632px] h-auto min-h-[300px] md:h-[400px] rounded-[32px] bg-[#294E3B] flex flex-col items-center justify-center gap-4 px-5 md:px-[26px] py-12 md:py-[104px] relative overflow-hidden ${className}`}>
      ...
      <h2 className="font-semibold text-2xl md:text-[42px] leading-[100%] tracking-[-0.04em] text-center text-white z-10">{title}</h2>
